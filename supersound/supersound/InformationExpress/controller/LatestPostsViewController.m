...
#import "LatestPostsTableViewCell.h"

@interface LatestPostsViewController ()<UITableViewDataSource,UITableViewDelegate>

@end

@implementation LatestPostsViewController
...
{
    static NSString *LatestPostsTableView = @"LatestPostsTableViewCell";
    
    LatestPostsTableViewCell *rCell = [tableView dequeueReusableCellWithIdentifier:LatestPostsTableView];
    if(rCell == nil)
    {
        rCell= [[[NSBundle mainBundle] loadNibNamed:LatestPostsTableView owner:nil options:nil] lastObject];
    }
