//
//  InformationExpressViewController.m
//  supersound
//
...
#import "LatestPostsViewController.h"
#import "SearchViewController.h"
#import "ProductsInformationViewController.h"



@interface InformationExpressViewController ()<UITableViewDataSource,UITableViewDelegate,SDCycleScrollViewDelegate>
{
...
@implementation InformationExpressViewController
...
{
    _tableView = [[UITableView alloc]initWithFrame: CGRectMake(0 , 64, ScreenWidth, ScreenHeight-64 - 44)];
...
- (void)createscrollview
{
    ...
    [_imgArr addObject:@"产品资讯.png"];
    [_imgArr addObject:@"最新文章.png"];
    [_imgArr addObject:@"文献.png"];
    [_imgArr addObject:@"应用指南.png"];
    _imgnameArr=[[NSMutableArray alloc]init];
    [_imgnameArr addObject:@"产品资讯"];
    [_imgnameArr addObject:@"最新文章"];
    [_imgnameArr addObject:@"查找文献"];
    [_imgnameArr addObject:@"应用指南"];
    ...
    for (int i = 0;i < 4;i++) {
        NSInteger index = i;
        UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(spaceWidth+i*width, 0*(btnWidth+28)+8+125, btnWidth, btnWidth)];
...
//            [btn sd_setImageWithURL:[NSURL URLWithString:_imgArr[index]] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"1.png"]];
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(i*width ,
                                                                   btn.frame.origin.y + btn.frame.size.height+3,
                                                                   width, 18)];
