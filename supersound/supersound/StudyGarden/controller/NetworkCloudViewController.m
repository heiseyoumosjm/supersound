...
@interface NetworkCloudViewController ()<UITableViewDataSource,UITableViewDelegate,SDCycleScrollViewDelegate>
{
...
@implementation NetworkCloudViewController
...
- (void)createscrollview
{
    ...
    [_imgArr addObject:@"公开课"];
    [_imgArr addObject:@"标准课"];
    [_imgArr addObject:@"培训视频"];
 
    _imgnameArr=[[NSMutableArray alloc]init];
    [_imgnameArr addObject:@"公开课"];
    [_imgnameArr addObject:@"标准课"];
    [_imgnameArr addObject:@"培训视频"];
    ...
    for (int i = 0;i < 3;i++) {
        ...
        if (index< 3&&index<_imgArr.count) {
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(i*width ,
                                                                   ...
                                                                   width, 18)];
        if (index< 3&&index<_imgnameArr.count) {
